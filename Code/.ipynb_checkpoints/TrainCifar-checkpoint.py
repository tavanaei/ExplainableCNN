...
net = Model(G_kernels=g_kernels,D_kernels=d_kernels,G_strides=g_strides,D_strides=d_strides,G_patch=g_patch,D_patch=d_patch,fcc_layers=fc_layers,G_pool='average',D_pool='max',dropout=drop,prob=False)
...
for epoch in range(opt.epoch):
    ...
    if epoch>0 and epoch%decay_step==0:
        ...
        for param_group in optimizer.param_groups:
                param_group['lr'] = lr
model_name = 'Models/Model_Cifar_128'
